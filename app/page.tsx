...
// TODO Carregar sprites e animações suficientes para o estágio do personagem carregado
...
const sprites: SpriteConfig = {
  ...
  Evoluindo1: { posX: 142, posY: 46, larg: 31, alt: 16 },
  Evoluindo2: { posX: 174, posY: 46, larg: 31, alt: 16 },
  Evoluindo3: { posX: 142, posY: 62, larg: 31, alt: 16 },
  Evoluindo4: { posX: 174, posY: 62, larg: 31, alt: 16 },
  Evoluindo5: { posX: 142, posY: 79, larg: 31, alt: 16 },
  Evoluindo6: { posX: 174, posY: 79, larg: 31, alt: 16 },
  Evoluindo7: { posX: 142, posY: 96, larg: 31, alt: 16 },
  Evoluindo8: { posX: 174, posY: 96, larg: 31, alt: 16 },
...
export const animations = createAnimations ({
    OvoIdle: { loop: 0, quadros: [
      { duracao: 600, imagens: [ { imagem: sprites.OvoP1A1, posicao: "fixa", posX: 11, posY: 3 } ] },
      { duracao: 600, imagens: [ { imagem: sprites.OvoP1A2, posicao: "fixa", posX: 10, posY: 4 } ] },
    ]
  },
  OvoEvoluindo1: { loop: 3, acao: "OvoEvoluindo2", quadros: [
      { duracao: 300, imagens: [ { imagem: sprites.OvoP1A2, posicao: "fixa", posX: 10, posY: 4 } ] },
      { duracao: 300, imagens: [ { imagem: sprites.OvoP1A2, posicao: "fixa", posX: 9, posY: 4 } ] },
    ]
  },
  OvoEvoluindo2: { loop: 1, acao: "BabitchiP1Idle", quadros: [
      { duracao: 900, imagens: [ { imagem: sprites.OvoP1A3, posicao: "fixa", posX: 8, posY: 1 } ] },
